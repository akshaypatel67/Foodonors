...
import com.example.foodonors.databinding.ActivityMapsBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("lat", String.valueOf(loc.latitude));
                Log.d("long", String.valueOf(loc.longitude));
                setResult(2,intent);
                finish();
            }
        });
                ...
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        if (location != null) {
                            ...
                            mMap.addMarker(new MarkerOptions().position(currLoc).title("Mark Location"));
